<template>
	<v-container class="order-general fill-height overflow-y-auto " fluid>
		<v-row>
			<v-col cols="6">你正在反對</v-col>
			<v-col cols="6">使用钱包</v-col>
			<v-col cols="6">波胆1-0</v-col>
			<v-col cols="6">
		...
		<v-row>
			...
			<v-col cols="12">
				<span>预估获利</span>
				<span>120,450.80</span>
			</v-col>
		</v-row>
		<v-row>
			<v-col cols="12">请确认交易明细无误，确认交易后无法改注单</v-col>
			<v-col cols="12">TG余额:3,168,500.00</v-col>
			<v-btn block>確定</v-btn>
		</v-row>
	</v-container>
</template>
